...
class ha_vtml : public handler {
 ...
 public:
   ...
   */
  const char *table_type() const { return "VTML"; }
  ...
  */
  ...
  /*
    Everything below are methods that we implement in ha_vtml.cc.

    Most of these methods are not obligatory, skip them and
    MySQL will treat them as not implemented
  */
  /** @brief
    We implement this in ha_vtml.cc; it's a required method.
  */
